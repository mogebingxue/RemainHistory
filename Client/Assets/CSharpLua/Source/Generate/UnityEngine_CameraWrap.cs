...
public class UnityEngine_CameraWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getnearClipPlane", get_nearClipPlane);
		L.RegFunction("setnearClipPlane", set_nearClipPlane);
		L.RegVar("farClipPlane", get_farClipPlane, set_farClipPlane);
		L.RegFunction("getfarClipPlane", get_farClipPlane);
		L.RegFunction("setfarClipPlane", set_farClipPlane);
		L.RegVar("fieldOfView", get_fieldOfView, set_fieldOfView);
		L.RegFunction("getfieldOfView", get_fieldOfView);
		L.RegFunction("setfieldOfView", set_fieldOfView);
		L.RegVar("renderingPath", get_renderingPath, set_renderingPath);
		L.RegFunction("getrenderingPath", get_renderingPath);
		L.RegFunction("setrenderingPath", set_renderingPath);
		L.RegVar("actualRenderingPath", get_actualRenderingPath, null);
		L.RegFunction("getactualRenderingPath", get_actualRenderingPath);
		L.RegVar("allowHDR", get_allowHDR, set_allowHDR);
		L.RegFunction("getallowHDR", get_allowHDR);
		L.RegFunction("setallowHDR", set_allowHDR);
		L.RegVar("allowMSAA", get_allowMSAA, set_allowMSAA);
		L.RegFunction("getallowMSAA", get_allowMSAA);
		L.RegFunction("setallowMSAA", set_allowMSAA);
		L.RegVar("allowDynamicResolution", get_allowDynamicResolution, set_allowDynamicResolution);
		L.RegFunction("getallowDynamicResolution", get_allowDynamicResolution);
		L.RegFunction("setallowDynamicResolution", set_allowDynamicResolution);
		L.RegVar("forceIntoRenderTexture", get_forceIntoRenderTexture, set_forceIntoRenderTexture);
		L.RegFunction("getforceIntoRenderTexture", get_forceIntoRenderTexture);
		L.RegFunction("setforceIntoRenderTexture", set_forceIntoRenderTexture);
		L.RegVar("orthographicSize", get_orthographicSize, set_orthographicSize);
		L.RegFunction("getorthographicSize", get_orthographicSize);
		L.RegFunction("setorthographicSize", set_orthographicSize);
		L.RegVar("orthographic", get_orthographic, set_orthographic);
		L.RegFunction("getorthographic", get_orthographic);
		L.RegFunction("setorthographic", set_orthographic);
		L.RegVar("opaqueSortMode", get_opaqueSortMode, set_opaqueSortMode);
		L.RegFunction("getopaqueSortMode", get_opaqueSortMode);
		L.RegFunction("setopaqueSortMode", set_opaqueSortMode);
		L.RegVar("transparencySortMode", get_transparencySortMode, set_transparencySortMode);
		L.RegFunction("gettransparencySortMode", get_transparencySortMode);
		L.RegFunction("settransparencySortMode", set_transparencySortMode);
		L.RegVar("transparencySortAxis", get_transparencySortAxis, set_transparencySortAxis);
		L.RegFunction("gettransparencySortAxis", get_transparencySortAxis);
		L.RegFunction("settransparencySortAxis", set_transparencySortAxis);
		...
		L.RegFunction("getaspect", get_aspect);
		L.RegFunction("setaspect", set_aspect);
		...
		L.RegFunction("geteventMask", get_eventMask);
		L.RegFunction("seteventMask", set_eventMask);
		L.RegVar("layerCullSpherical", get_layerCullSpherical, set_layerCullSpherical);
		L.RegFunction("getlayerCullSpherical", get_layerCullSpherical);
		L.RegFunction("setlayerCullSpherical", set_layerCullSpherical);
		L.RegVar("cameraType", get_cameraType, set_cameraType);
		L.RegFunction("getcameraType", get_cameraType);
		L.RegFunction("setcameraType", set_cameraType);
		L.RegVar("overrideSceneCullingMask", get_overrideSceneCullingMask, set_overrideSceneCullingMask);
		L.RegFunction("getoverrideSceneCullingMask", get_overrideSceneCullingMask);
		L.RegFunction("setoverrideSceneCullingMask", set_overrideSceneCullingMask);
		L.RegVar("layerCullDistances", get_layerCullDistances, set_layerCullDistances);
		L.RegFunction("getlayerCullDistances", get_layerCullDistances);
		L.RegFunction("setlayerCullDistances", set_layerCullDistances);
		L.RegVar("useOcclusionCulling", get_useOcclusionCulling, set_useOcclusionCulling);
		L.RegFunction("getuseOcclusionCulling", get_useOcclusionCulling);
		L.RegFunction("setuseOcclusionCulling", set_useOcclusionCulling);
		L.RegVar("cullingMatrix", get_cullingMatrix, set_cullingMatrix);
		L.RegFunction("getcullingMatrix", get_cullingMatrix);
		L.RegFunction("setcullingMatrix", set_cullingMatrix);
		L.RegVar("backgroundColor", get_backgroundColor, set_backgroundColor);
		L.RegFunction("getbackgroundColor", get_backgroundColor);
		L.RegFunction("setbackgroundColor", set_backgroundColor);
		L.RegVar("clearFlags", get_clearFlags, set_clearFlags);
		L.RegFunction("getclearFlags", get_clearFlags);
		L.RegFunction("setclearFlags", set_clearFlags);
		L.RegVar("depthTextureMode", get_depthTextureMode, set_depthTextureMode);
		L.RegFunction("getdepthTextureMode", get_depthTextureMode);
		L.RegFunction("setdepthTextureMode", set_depthTextureMode);
		L.RegVar("clearStencilAfterLightingPass", get_clearStencilAfterLightingPass, set_clearStencilAfterLightingPass);
		L.RegFunction("getclearStencilAfterLightingPass", get_clearStencilAfterLightingPass);
		L.RegFunction("setclearStencilAfterLightingPass", set_clearStencilAfterLightingPass);
		L.RegVar("usePhysicalProperties", get_usePhysicalProperties, set_usePhysicalProperties);
		L.RegFunction("getusePhysicalProperties", get_usePhysicalProperties);
		L.RegFunction("setusePhysicalProperties", set_usePhysicalProperties);
		L.RegVar("sensorSize", get_sensorSize, set_sensorSize);
		L.RegFunction("getsensorSize", get_sensorSize);
		L.RegFunction("setsensorSize", set_sensorSize);
		L.RegVar("lensShift", get_lensShift, set_lensShift);
		L.RegFunction("getlensShift", get_lensShift);
		L.RegFunction("setlensShift", set_lensShift);
		...
		L.RegFunction("getgateFit", get_gateFit);
		L.RegFunction("setgateFit", set_gateFit);
		L.RegVar("rect", get_rect, set_rect);
		L.RegFunction("getrect", get_rect);
		L.RegFunction("setrect", set_rect);
		L.RegVar("pixelRect", get_pixelRect, set_pixelRect);
		L.RegFunction("getpixelRect", get_pixelRect);
		L.RegFunction("setpixelRect", set_pixelRect);
		L.RegVar("pixelWidth", get_pixelWidth, null);
		L.RegFunction("getpixelWidth", get_pixelWidth);
		L.RegVar("pixelHeight", get_pixelHeight, null);
		L.RegFunction("getpixelHeight", get_pixelHeight);
		L.RegVar("scaledPixelWidth", get_scaledPixelWidth, null);
		L.RegFunction("getscaledPixelWidth", get_scaledPixelWidth);
		L.RegVar("scaledPixelHeight", get_scaledPixelHeight, null);
		L.RegFunction("getscaledPixelHeight", get_scaledPixelHeight);
		L.RegVar("targetTexture", get_targetTexture, set_targetTexture);
		L.RegFunction("gettargetTexture", get_targetTexture);
		L.RegFunction("settargetTexture", set_targetTexture);
		L.RegVar("activeTexture", get_activeTexture, null);
		L.RegFunction("getactiveTexture", get_activeTexture);
		...
		L.RegFunction("getcameraToWorldMatrix", get_cameraToWorldMatrix);
		L.RegVar("worldToCameraMatrix", get_worldToCameraMatrix, set_worldToCameraMatrix);
		L.RegFunction("getworldToCameraMatrix", get_worldToCameraMatrix);
		L.RegFunction("setworldToCameraMatrix", set_worldToCameraMatrix);
		L.RegVar("projectionMatrix", get_projectionMatrix, set_projectionMatrix);
		L.RegFunction("getprojectionMatrix", get_projectionMatrix);
		L.RegFunction("setprojectionMatrix", set_projectionMatrix);
		L.RegVar("nonJitteredProjectionMatrix", get_nonJitteredProjectionMatrix, set_nonJitteredProjectionMatrix);
		L.RegFunction("getnonJitteredProjectionMatrix", get_nonJitteredProjectionMatrix);
		L.RegFunction("setnonJitteredProjectionMatrix", set_nonJitteredProjectionMatrix);
		...
		L.RegFunction("getuseJitteredProjectionMatrixForTransparentRendering", get_useJitteredProjectionMatrixForTransparentRendering);
		L.RegFunction("setuseJitteredProjectionMatrixForTransparentRendering", set_useJitteredProjectionMatrixForTransparentRendering);
		L.RegVar("previousViewProjectionMatrix", get_previousViewProjectionMatrix, null);
		L.RegFunction("getpreviousViewProjectionMatrix", get_previousViewProjectionMatrix);
		L.RegVar("main", get_main, null);
		L.RegFunction("getmain", get_main);
		...
		L.RegFunction("setscene", set_scene);
		L.RegVar("stereoEnabled", get_stereoEnabled, null);
		L.RegFunction("getstereoEnabled", get_stereoEnabled);
		L.RegVar("stereoSeparation", get_stereoSeparation, set_stereoSeparation);
		L.RegFunction("getstereoSeparation", get_stereoSeparation);
		L.RegFunction("setstereoSeparation", set_stereoSeparation);
		L.RegVar("stereoConvergence", get_stereoConvergence, set_stereoConvergence);
		L.RegFunction("getstereoConvergence", get_stereoConvergence);
		L.RegFunction("setstereoConvergence", set_stereoConvergence);
		L.RegVar("areVRStereoViewMatricesWithinSingleCullTolerance", get_areVRStereoViewMatricesWithinSingleCullTolerance, null);
		L.RegFunction("getareVRStereoViewMatricesWithinSingleCullTolerance", get_areVRStereoViewMatricesWithinSingleCullTolerance);
		L.RegVar("stereoTargetEye", get_stereoTargetEye, set_stereoTargetEye);
		L.RegFunction("getstereoTargetEye", get_stereoTargetEye);
		L.RegFunction("setstereoTargetEye", set_stereoTargetEye);
		L.RegVar("stereoActiveEye", get_stereoActiveEye, null);
		L.RegFunction("getstereoActiveEye", get_stereoActiveEye);
		L.RegVar("allCamerasCount", get_allCamerasCount, null);
		L.RegFunction("getallCamerasCount", get_allCamerasCount);
		L.RegVar("allCameras", get_allCameras, null);
		L.RegFunction("getallCameras", get_allCameras);
	...
	static int WorldToScreenPoint(IntPtr L)
	{
		try
		{
			...
			else if (count == 3)
			{
				UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.CheckObject(L, 1, typeof(UnityEngine.Camera));
				UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 2);
				UnityEngine.Camera.MonoOrStereoscopicEye arg1 = (UnityEngine.Camera.MonoOrStereoscopicEye)LuaDLL.luaL_checknumber(L, 3);
	...
	static int CalculateFrustumCorners(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Camera.MonoOrStereoscopicEye arg2 = (UnityEngine.Camera.MonoOrStereoscopicEye)LuaDLL.luaL_checknumber(L, 4);
	...
	static int GetStereoNonJitteredProjectionMatrix(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.CheckObject(L, 1, typeof(UnityEngine.Camera));
			UnityEngine.Camera.StereoscopicEye arg0 = (UnityEngine.Camera.StereoscopicEye)LuaDLL.luaL_checknumber(L, 2);
	...
	static int RemoveCommandBuffers(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
			UnityEngine.Camera obj = (UnityEngine.Camera)ToLua.CheckObject(L, 1, typeof(UnityEngine.Camera));
			UnityEngine.Rendering.CameraEvent arg0 = (UnityEngine.Rendering.CameraEvent)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_renderingPath(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.RenderingPath arg0 = (UnityEngine.RenderingPath)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_opaqueSortMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.Rendering.OpaqueSortMode arg0 = (UnityEngine.Rendering.OpaqueSortMode)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_transparencySortMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.TransparencySortMode arg0 = (UnityEngine.TransparencySortMode)LuaDLL.luaL_checknumber(L, 2);
	...
	static int set_cameraType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.CameraType arg0 = (UnityEngine.CameraType)LuaDLL.luaL_checknumber(L, 2);
			obj.cameraType = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_clearFlags(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.CameraClearFlags arg0 = (UnityEngine.CameraClearFlags)LuaDLL.luaL_checknumber(L, 2);
			obj.clearFlags = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_gateFit(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.Camera.GateFitMode arg0 = (UnityEngine.Camera.GateFitMode)LuaDLL.luaL_checknumber(L, 2);
			obj.gateFit = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_stereoTargetEye(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Camera obj = (UnityEngine.Camera)o;
			UnityEngine.StereoTargetEyeMask arg0 = (UnityEngine.StereoTargetEyeMask)LuaDLL.luaL_checknumber(L, 2);
