...
public class UnityEngine_LightWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getshape", get_shape);
		L.RegFunction("setshape", set_shape);
		...
		L.RegFunction("getinnerSpotAngle", get_innerSpotAngle);
		L.RegFunction("setinnerSpotAngle", set_innerSpotAngle);
		...
		L.RegFunction("getcolorTemperature", get_colorTemperature);
		L.RegFunction("setcolorTemperature", set_colorTemperature);
		L.RegVar("useColorTemperature", get_useColorTemperature, set_useColorTemperature);
		L.RegFunction("getuseColorTemperature", get_useColorTemperature);
		L.RegFunction("setuseColorTemperature", set_useColorTemperature);
		...
		L.RegFunction("getuseBoundingSphereOverride", get_useBoundingSphereOverride);
		L.RegFunction("setuseBoundingSphereOverride", set_useBoundingSphereOverride);
		L.RegVar("boundingSphereOverride", get_boundingSphereOverride, set_boundingSphereOverride);
		L.RegFunction("getboundingSphereOverride", get_boundingSphereOverride);
		L.RegFunction("setboundingSphereOverride", set_boundingSphereOverride);
		...
		L.RegFunction("getuseShadowMatrixOverride", get_useShadowMatrixOverride);
		L.RegFunction("setuseShadowMatrixOverride", set_useShadowMatrixOverride);
		L.RegVar("shadowMatrixOverride", get_shadowMatrixOverride, set_shadowMatrixOverride);
		L.RegFunction("getshadowMatrixOverride", get_shadowMatrixOverride);
		L.RegFunction("setshadowMatrixOverride", set_shadowMatrixOverride);
		...
		L.RegFunction("getbakingOutput", get_bakingOutput);
		L.RegFunction("setbakingOutput", set_bakingOutput);
		...
		L.RegFunction("getlightShadowCasterMode", get_lightShadowCasterMode);
		L.RegFunction("setlightShadowCasterMode", set_lightShadowCasterMode);
		...
		L.RegFunction("getlayerShadowCullDistances", get_layerShadowCullDistances);
		L.RegFunction("setlayerShadowCullDistances", set_layerShadowCullDistances);
	...
	static int set_shape(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			UnityEngine.LightShape arg0 = (UnityEngine.LightShape)LuaDLL.luaL_checknumber(L, 2);
			obj.shape = arg0;
			return 0;
		}
		catch(Exception e)
	...
	static int set_lightShadowCasterMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Light obj = (UnityEngine.Light)o;
			UnityEngine.LightShadowCasterMode arg0 = (UnityEngine.LightShadowCasterMode)LuaDLL.luaL_checknumber(L, 2);
