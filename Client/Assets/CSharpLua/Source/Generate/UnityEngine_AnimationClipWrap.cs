...
public class UnityEngine_AnimationClipWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("gethasGenericRootTransform", get_hasGenericRootTransform);
		L.RegVar("hasMotionFloatCurves", get_hasMotionFloatCurves, null);
		L.RegFunction("gethasMotionFloatCurves", get_hasMotionFloatCurves);
		L.RegVar("hasMotionCurves", get_hasMotionCurves, null);
		L.RegFunction("gethasMotionCurves", get_hasMotionCurves);
		L.RegVar("hasRootCurves", get_hasRootCurves, null);
		L.RegFunction("gethasRootCurves", get_hasRootCurves);
