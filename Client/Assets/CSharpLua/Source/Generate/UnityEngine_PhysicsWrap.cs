...
public class UnityEngine_PhysicsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getdefaultMaxAngularSpeed", get_defaultMaxAngularSpeed);
		L.RegFunction("setdefaultMaxAngularSpeed", set_defaultMaxAngularSpeedter);
		L.RegVar("defaultPhysicsScene", get_defaultPhysicsScene, null);
		L.RegFunction("getdefaultPhysicsScene", get_defaultPhysicsScene);
		...
		L.RegFunction("getreuseCollisionCallbacks", get_reuseCollisionCallbacks);
		L.RegFunction("setreuseCollisionCallbacks", set_reuseCollisionCallbackster);
		...
		L.RegFunction("getclothGravity", get_clothGravity);
		L.RegFunction("setclothGravity", set_clothGravityter);
		L.EndStaticLibs();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_defaultMaxAngularSpeedter(IntPtr L)
	{
		try
		{
			float arg0 = (float)LuaDLL.luaL_checknumber(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_reuseCollisionCallbackster(IntPtr L)
	{
		try
		{
			bool arg0 = LuaDLL.luaL_checkboolean(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_clothGravityter(IntPtr L)
	{
		try
		{
			UnityEngine.Vector3 arg0 = ToLua.ToVector3(L, 1);
