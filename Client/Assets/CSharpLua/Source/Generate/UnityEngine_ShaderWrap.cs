...
public class UnityEngine_ShaderWrap
{
	...
	static int SetGlobalTexture(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes<int, UnityEngine.RenderTexture, uint>(L, 1))
			{
				int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
				UnityEngine.RenderTexture arg1 = (UnityEngine.RenderTexture)ToLua.ToObject(L, 2);
				UnityEngine.Rendering.RenderTextureSubElement arg2 = (UnityEngine.Rendering.RenderTextureSubElement)LuaDLL.lua_tonumber(L, 3);
				UnityEngine.Shader.SetGlobalTexture(arg0, arg1, arg2);
				return 0;
			}
			else if (count == 3 && TypeChecker.CheckTypes<string, UnityEngine.RenderTexture, uint>(L, 1))
			{
				string arg0 = ToLua.ToString(L, 1);
				UnityEngine.RenderTexture arg1 = (UnityEngine.RenderTexture)ToLua.ToObject(L, 2);
				UnityEngine.Rendering.RenderTextureSubElement arg2 = (UnityEngine.Rendering.RenderTextureSubElement)LuaDLL.lua_tonumber(L, 3);
