...
public class UnityEngine_MeshRendererWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getsubMeshStartIndex", get_subMeshStartIndex);
		L.RegVar("scaleInLightmap", get_scaleInLightmap, set_scaleInLightmap);
		L.RegFunction("getscaleInLightmap", get_scaleInLightmap);
		L.RegFunction("setscaleInLightmap", set_scaleInLightmap);
		L.RegVar("receiveGI", get_receiveGI, set_receiveGI);
		L.RegFunction("getreceiveGI", get_receiveGI);
		L.RegFunction("setreceiveGI", set_receiveGI);
		L.RegVar("stitchLightmapSeams", get_stitchLightmapSeams, set_stitchLightmapSeams);
		L.RegFunction("getstitchLightmapSeams", get_stitchLightmapSeams);
		L.RegFunction("setstitchLightmapSeams", set_stitchLightmapSeams);
		L.EndClass();
	}
