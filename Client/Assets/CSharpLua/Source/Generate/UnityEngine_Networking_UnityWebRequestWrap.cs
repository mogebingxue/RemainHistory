...
public class UnityEngine_Networking_UnityWebRequestWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getdisposeCertificateHandlerOnDispose", get_disposeCertificateHandlerOnDispose);
		L.RegFunction("setdisposeCertificateHandlerOnDispose", set_disposeCertificateHandlerOnDispose);
		L.RegVar("disposeDownloadHandlerOnDispose", get_disposeDownloadHandlerOnDispose, set_disposeDownloadHandlerOnDispose);
		L.RegFunction("getdisposeDownloadHandlerOnDispose", get_disposeDownloadHandlerOnDispose);
		L.RegFunction("setdisposeDownloadHandlerOnDispose", set_disposeDownloadHandlerOnDispose);
		L.RegVar("disposeUploadHandlerOnDispose", get_disposeUploadHandlerOnDispose, set_disposeUploadHandlerOnDispose);
		L.RegFunction("getdisposeUploadHandlerOnDispose", get_disposeUploadHandlerOnDispose);
		L.RegFunction("setdisposeUploadHandlerOnDispose", set_disposeUploadHandlerOnDispose);
		...
		L.RegFunction("getuseHttpContinue", get_useHttpContinue);
		L.RegFunction("setuseHttpContinue", set_useHttpContinue);
		L.RegVar("url", get_url, set_url);
		L.RegFunction("geturl", get_url);
		L.RegFunction("seturl", set_url);
		L.RegVar("uri", get_uri, set_uri);
		L.RegFunction("geturi", get_uri);
		L.RegFunction("seturi", set_uri);
		L.RegVar("responseCode", get_responseCode, null);
		L.RegFunction("getresponseCode", get_responseCode);
		...
		L.RegFunction("getisModifiable", get_isModifiable);
		L.RegVar("isDone", get_isDone, null);
		L.RegFunction("getisDone", get_isDone);
		L.RegVar("isNetworkError", get_isNetworkError, null);
		L.RegFunction("getisNetworkError", get_isNetworkError);
		L.RegVar("isHttpError", get_isHttpError, null);
		L.RegFunction("getisHttpError", get_isHttpError);
		L.RegVar("downloadProgress", get_downloadProgress, null);
		L.RegFunction("getdownloadProgress", get_downloadProgress);
		L.RegVar("uploadedBytes", get_uploadedBytes, null);
		L.RegFunction("getuploadedBytes", get_uploadedBytes);
		L.RegVar("downloadedBytes", get_downloadedBytes, null);
		L.RegFunction("getdownloadedBytes", get_downloadedBytes);
		L.RegVar("redirectLimit", get_redirectLimit, set_redirectLimit);
		L.RegFunction("getredirectLimit", get_redirectLimit);
		L.RegFunction("setredirectLimit", set_redirectLimit);
		L.RegVar("uploadHandler", get_uploadHandler, set_uploadHandler);
		L.RegFunction("getuploadHandler", get_uploadHandler);
		L.RegFunction("setuploadHandler", set_uploadHandler);
		L.RegVar("downloadHandler", get_downloadHandler, set_downloadHandler);
		L.RegFunction("getdownloadHandler", get_downloadHandler);
		L.RegFunction("setdownloadHandler", set_downloadHandler);
		L.RegVar("certificateHandler", get_certificateHandler, set_certificateHandler);
		L.RegFunction("getcertificateHandler", get_certificateHandler);
		L.RegFunction("setcertificateHandler", set_certificateHandler);
		L.RegVar("timeout", get_timeout, set_timeout);
		L.RegFunction("gettimeout", get_timeout);
		L.RegFunction("settimeout", set_timeout);
		L.EndClass();
	}
