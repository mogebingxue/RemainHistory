...
public class UnityEngine_AsyncOperationWrap
{
	...
	static int addcompleted(IntPtr L)
	{
		try
		{
			...
			var obj = (UnityEngine.AsyncOperation)ToLua.CheckObject(L, 1, typeof(UnityEngine.AsyncOperation));
			var arg0 = (System.Action<UnityEngine.AsyncOperation>)ToLua.CheckDelegate<System.Action<UnityEngine.AsyncOperation>>(L, 2);
			obj.completed += arg0;
			return 0;
		}
		catch (Exception e)
