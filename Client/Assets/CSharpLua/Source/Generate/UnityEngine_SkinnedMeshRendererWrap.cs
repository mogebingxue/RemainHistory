...
public class UnityEngine_SkinnedMeshRendererWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getforceMatrixRecalculationPerRender", get_forceMatrixRecalculationPerRender);
		L.RegFunction("setforceMatrixRecalculationPerRender", set_forceMatrixRecalculationPerRender);
