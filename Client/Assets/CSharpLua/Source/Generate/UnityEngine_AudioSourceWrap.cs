...
public class UnityEngine_AudioSourceWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("setvolume", set_volume);
		L.RegVar("pitch", get_pitch, set_pitch);
		L.RegFunction("getpitch", get_pitch);
		L.RegFunction("setpitch", set_pitch);
		L.RegVar("time", get_time, set_time);
		L.RegFunction("gettime", get_time);
		L.RegFunction("settime", set_time);
		L.RegVar("timeSamples", get_timeSamples, set_timeSamples);
		L.RegFunction("gettimeSamples", get_timeSamples);
		L.RegFunction("settimeSamples", set_timeSamples);
		...
		L.RegFunction("getoutputAudioMixerGroup", get_outputAudioMixerGroup);
		L.RegFunction("setoutputAudioMixerGroup", set_outputAudioMixerGroup);
		L.RegVar("isPlaying", get_isPlaying, null);
		L.RegFunction("getisPlaying", get_isPlaying);
		L.RegVar("isVirtual", get_isVirtual, null);
		L.RegFunction("getisVirtual", get_isVirtual);
		L.RegVar("loop", get_loop, set_loop);
		L.RegFunction("getloop", get_loop);
		L.RegFunction("setloop", set_loop);
		L.RegVar("ignoreListenerVolume", get_ignoreListenerVolume, set_ignoreListenerVolume);
		L.RegFunction("getignoreListenerVolume", get_ignoreListenerVolume);
		L.RegFunction("setignoreListenerVolume", set_ignoreListenerVolume);
		L.RegVar("playOnAwake", get_playOnAwake, set_playOnAwake);
		L.RegFunction("getplayOnAwake", get_playOnAwake);
		L.RegFunction("setplayOnAwake", set_playOnAwake);
		L.RegVar("ignoreListenerPause", get_ignoreListenerPause, set_ignoreListenerPause);
		L.RegFunction("getignoreListenerPause", get_ignoreListenerPause);
		L.RegFunction("setignoreListenerPause", set_ignoreListenerPause);
		...
		L.RegFunction("getpanStereo", get_panStereo);
		L.RegFunction("setpanStereo", set_panStereo);
		L.RegVar("spatialBlend", get_spatialBlend, set_spatialBlend);
		L.RegFunction("getspatialBlend", get_spatialBlend);
		L.RegFunction("setspatialBlend", set_spatialBlend);
		L.RegVar("spatialize", get_spatialize, set_spatialize);
		L.RegFunction("getspatialize", get_spatialize);
		L.RegFunction("setspatialize", set_spatialize);
		L.RegVar("spatializePostEffects", get_spatializePostEffects, set_spatializePostEffects);
		L.RegFunction("getspatializePostEffects", get_spatializePostEffects);
		L.RegFunction("setspatializePostEffects", set_spatializePostEffects);
		L.RegVar("reverbZoneMix", get_reverbZoneMix, set_reverbZoneMix);
		L.RegFunction("getreverbZoneMix", get_reverbZoneMix);
		L.RegFunction("setreverbZoneMix", set_reverbZoneMix);
		L.RegVar("bypassEffects", get_bypassEffects, set_bypassEffects);
		L.RegFunction("getbypassEffects", get_bypassEffects);
		L.RegFunction("setbypassEffects", set_bypassEffects);
		L.RegVar("bypassListenerEffects", get_bypassListenerEffects, set_bypassListenerEffects);
		L.RegFunction("getbypassListenerEffects", get_bypassListenerEffects);
		L.RegFunction("setbypassListenerEffects", set_bypassListenerEffects);
		L.RegVar("bypassReverbZones", get_bypassReverbZones, set_bypassReverbZones);
		L.RegFunction("getbypassReverbZones", get_bypassReverbZones);
		L.RegFunction("setbypassReverbZones", set_bypassReverbZones);
		L.RegVar("dopplerLevel", get_dopplerLevel, set_dopplerLevel);
		L.RegFunction("getdopplerLevel", get_dopplerLevel);
		L.RegFunction("setdopplerLevel", set_dopplerLevel);
		L.RegVar("spread", get_spread, set_spread);
		L.RegFunction("getspread", get_spread);
		L.RegFunction("setspread", set_spread);
		...
		L.RegFunction("getmute", get_mute);
		L.RegFunction("setmute", set_mute);
		L.RegVar("minDistance", get_minDistance, set_minDistance);
		L.RegFunction("getminDistance", get_minDistance);
		L.RegFunction("setminDistance", set_minDistance);
		L.RegVar("maxDistance", get_maxDistance, set_maxDistance);
		L.RegFunction("getmaxDistance", get_maxDistance);
		L.RegFunction("setmaxDistance", set_maxDistance);
		L.RegVar("rolloffMode", get_rolloffMode, set_rolloffMode);
		L.RegFunction("getrolloffMode", get_rolloffMode);
		L.RegFunction("setrolloffMode", set_rolloffMode);
		L.EndClass();
	}
