...
public class UnityEngine_RendererWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getshadowCastingMode", get_shadowCastingMode);
		L.RegFunction("setshadowCastingMode", set_shadowCastingMode);
		L.RegVar("receiveShadows", get_receiveShadows, set_receiveShadows);
		L.RegFunction("getreceiveShadows", get_receiveShadows);
		L.RegFunction("setreceiveShadows", set_receiveShadows);
		L.RegVar("forceRenderingOff", get_forceRenderingOff, set_forceRenderingOff);
		L.RegFunction("getforceRenderingOff", get_forceRenderingOff);
		L.RegFunction("setforceRenderingOff", set_forceRenderingOff);
		L.RegVar("motionVectorGenerationMode", get_motionVectorGenerationMode, set_motionVectorGenerationMode);
		L.RegFunction("getmotionVectorGenerationMode", get_motionVectorGenerationMode);
		L.RegFunction("setmotionVectorGenerationMode", set_motionVectorGenerationMode);
		L.RegVar("lightProbeUsage", get_lightProbeUsage, set_lightProbeUsage);
		L.RegFunction("getlightProbeUsage", get_lightProbeUsage);
		L.RegFunction("setlightProbeUsage", set_lightProbeUsage);
		L.RegVar("reflectionProbeUsage", get_reflectionProbeUsage, set_reflectionProbeUsage);
		L.RegFunction("getreflectionProbeUsage", get_reflectionProbeUsage);
		L.RegFunction("setreflectionProbeUsage", set_reflectionProbeUsage);
		L.RegVar("renderingLayerMask", get_renderingLayerMask, set_renderingLayerMask);
		L.RegFunction("getrenderingLayerMask", get_renderingLayerMask);
		L.RegFunction("setrenderingLayerMask", set_renderingLayerMask);
		L.RegVar("rendererPriority", get_rendererPriority, set_rendererPriority);
		L.RegFunction("getrendererPriority", get_rendererPriority);
		L.RegFunction("setrendererPriority", set_rendererPriority);
		L.RegVar("rayTracingMode", get_rayTracingMode, set_rayTracingMode);
		L.RegFunction("getrayTracingMode", get_rayTracingMode);
		L.RegFunction("setrayTracingMode", set_rayTracingMode);
		...
		L.RegFunction("getallowOcclusionWhenDynamic", get_allowOcclusionWhenDynamic);
		L.RegFunction("setallowOcclusionWhenDynamic", set_allowOcclusionWhenDynamic);
		L.RegVar("isPartOfStaticBatch", get_isPartOfStaticBatch, null);
		L.RegFunction("getisPartOfStaticBatch", get_isPartOfStaticBatch);
		...
		L.RegFunction("getlightProbeProxyVolumeOverride", get_lightProbeProxyVolumeOverride);
		L.RegFunction("setlightProbeProxyVolumeOverride", set_lightProbeProxyVolumeOverride);
		L.RegVar("probeAnchor", get_probeAnchor, set_probeAnchor);
		L.RegFunction("getprobeAnchor", get_probeAnchor);
		L.RegFunction("setprobeAnchor", set_probeAnchor);
		L.RegVar("lightmapIndex", get_lightmapIndex, set_lightmapIndex);
		L.RegFunction("getlightmapIndex", get_lightmapIndex);
		L.RegFunction("setlightmapIndex", set_lightmapIndex);
		L.RegVar("realtimeLightmapIndex", get_realtimeLightmapIndex, set_realtimeLightmapIndex);
		L.RegFunction("getrealtimeLightmapIndex", get_realtimeLightmapIndex);
		L.RegFunction("setrealtimeLightmapIndex", set_realtimeLightmapIndex);
		L.RegVar("lightmapScaleOffset", get_lightmapScaleOffset, set_lightmapScaleOffset);
		L.RegFunction("getlightmapScaleOffset", get_lightmapScaleOffset);
		L.RegFunction("setlightmapScaleOffset", set_lightmapScaleOffset);
		L.RegVar("realtimeLightmapScaleOffset", get_realtimeLightmapScaleOffset, set_realtimeLightmapScaleOffset);
		L.RegFunction("getrealtimeLightmapScaleOffset", get_realtimeLightmapScaleOffset);
		L.RegFunction("setrealtimeLightmapScaleOffset", set_realtimeLightmapScaleOffset);
		L.RegVar("materials", get_materials, set_materials);
		L.RegFunction("getmaterials", get_materials);
		L.RegFunction("setmaterials", set_materials);
		...
		L.RegFunction("getsharedMaterials", get_sharedMaterials);
		L.RegFunction("setsharedMaterials", set_sharedMaterials);
		L.EndClass();
	}
	...
	static int set_rayTracingMode(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityEngine.Renderer obj = (UnityEngine.Renderer)o;
			UnityEngine.Experimental.Rendering.RayTracingMode arg0 = (UnityEngine.Experimental.Rendering.RayTracingMode)LuaDLL.luaL_checknumber(L, 2);
