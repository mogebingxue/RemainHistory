...
public class UnityEngine_ScreenWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("getcutouts", get_cutouts);
		...
		L.RegFunction("getbrightness", get_brightness);
		L.RegFunction("setbrightness", set_brightnesster);
		L.EndStaticLibs();
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_brightnesster(IntPtr L)
	{
		try
		{
