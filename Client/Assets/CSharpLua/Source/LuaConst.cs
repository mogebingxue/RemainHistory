...
{
    public static string luaDir = Application.dataPath + "/HotFix/Scripts/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/CSharpLua/ToLua/Lua";        //tolua lua文件目录
