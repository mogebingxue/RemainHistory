...
{
    public static string saveDir = Application.dataPath + "/CSharpLua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/CSharpLua/ToLua/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/CSharpLua/Tolua/Lua/";
    public static string injectionFilesPath = Application.dataPath + "/CSharpLua/ToLua/Injection/";
